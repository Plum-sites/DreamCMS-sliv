							...
							<div class="chat-block mb-3" :key="index" :class="{'flex-row-reverse': chat.isAdmin}">
								<template v-if="!chat.isAdmin">
									...
									<div class="chat-bubble-wrap">
										...
										<span class="fs-12 grey--text text-xs-left d-block mt-1 fw-normal">{{chat.time}}</span>
									</div>
								</template>
								<template v-else>
									...
									<div class="chat-bubble-wrap">
										...
										<span class="fs-12 grey--text text-xs-right d-block mt-1 fw-normal">{{chat.time}}</span>
									</div>
								</template>
							</div>
						</template>
