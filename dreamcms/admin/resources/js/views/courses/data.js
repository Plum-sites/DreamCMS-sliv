export default {
	"courses" : [
		{
			...
			"describe" : "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical.",
		 	"features" : [
		 		...
		 		"Vivamus non ipsum in nisi porttitor suscipit.",
		 		"Aliquam ut dolor in lorem accumsan porta."
		 	]
		},
	...
	"courseDetail" : {
		...
		"learn" : [
			...
			"Proin sit amet ex in quam vehicula maximus sit amet vel mauris.",
			"Proin sit amet ex in quam vehicula maximus sit amet vel mauris",
			"Quisque hendrerit ex quis dui eleifend, dapibus vehicula lacus semper.",
			"Fusce ut libero consectetur, aliquet velit sed, hendrerit sem.",
			"Maecenas eget urna sagittis, efficitur arcu posuere, pellentesque metus",
			"Donec sit amet nisi ac tellus mattis venenatis volutpat sit amet mi"
		],
		"description" : {
