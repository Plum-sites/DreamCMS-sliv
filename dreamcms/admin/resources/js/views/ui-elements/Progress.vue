		...
		<v-container fluid grid-list-xl pt-0>
			...
			<v-layout row wrap>
				...
				>
					...
					<v-flex row justify-content-space-between text-xs-center>
						...
						<v-progress-circular indeterminate :size="70" :width="7" color="purple" class="mx-2"></v-progress-circular>
			...
			<v-layout row wrap>
				...
				>
					...
					<v-flex row justify-content-space-between text-xs-center>
						<v-progress-circular v-bind:size="100" v-bind:width="15" v-bind:rotate="360" v-bind:value="value" color="teal" class="mx-2 my-2">
							{{ value }}
						</v-progress-circular>
						<v-progress-circular v-bind:size="100" v-bind:width="15" v-bind:rotate="-90" v-bind:value="value" color="primary" class="mx-2 my-2">
							{{ value }}
						</v-progress-circular>
						<v-progress-circular v-bind:size="100" v-bind:width="15" v-bind:rotate="90" v-bind:value="value" color="red" class="mx-2 my-2">
							{{ value }}
						</v-progress-circular>
						<v-progress-circular v-bind:size="100" v-bind:width="15" v-bind:rotate="180" v-bind:value="value" color="pink" class="mx-2 my-2">
							{{ value }}
						</v-progress-circular>
					</v-flex>
				</app-card>
